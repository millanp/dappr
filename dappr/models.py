...
class RegistrationProfile(models.Model):
    ...
    def send_user_confirmation(self, request):
        ...
        self.confirmation_key = get_random_string(
            length=20, allowed_chars='0123456789')
        self.save()
        ...
        self.user.email_user(
            render_to_string(
                "registration/confirmation_email_subject.txt", context=context),
            render_to_string(
                "registration/confirmation_email.html", context=context),
    ...
    def send_admin_notification(self, request):
        ...
        Sets identity confirmed to true, then sends an email to the admin to notify
        ...
        mail_admins(
            render_to_string(
                "registration/admin_notification_email_subject.txt", context=context),
            render_to_string(
                "registration/admin_notification_email.html", context=context),
            html_message=render_to_string(
                "registration/admin_notification_email.html", context=context),
        )
    ...
    def send_approval_notification(self, request):
        ...
        self.user.email_user(
            render_to_string(
                "registration/success_email_subject.txt", context=context),
            render_to_string(
                "registration/success_email.html", context=context),
            html_message=render_to_string(
                "registration/success_email.html", context=context),
        )
    ...
    def send_rejection_notification(self, request):
        ...
        self.user.email_user(
            render_to_string(
                "registration/rejection_email_subject.txt", context=context),
            render_to_string(
                "registration/rejection_email.html", context=context),
            html_message=render_to_string(
                "registration/rejection_email.html", context=context),
        )
